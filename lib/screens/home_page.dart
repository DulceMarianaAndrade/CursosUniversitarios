...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final eventosMostrados = categoriaSeleccionada == 'Todos' ? eventos : eventos.where((evento) => evento['categoria'] == categoriaSeleccionada).toList();
                        ...
                        return EventCard(
                          ...
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Evento seleccionado: ${evento['titulo']}'),
                          ...
                          onTap: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => DetailPage(evento: evento),
                              ),
                            );
                          },
                        );
